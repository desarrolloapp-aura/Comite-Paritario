...
def enviar_inspeccion(request):
    ...
    if correo_destino:
        url_subir_evidencia = request.build_absolute_uri(reverse('evidencia_inspecciones', args=[nueva_inspeccion.token]))
...
def enviar_obsconducta(request):
    ...
    if correo_destino:
        url_subir_evidencia = request.build_absolute_uri(reverse('evidencia_obsconducta', args=[nueva_obsconducta.token]))
...
def enviar_reportehsgi(request):
    ...
    if correo_destino:
        url_subir_evidencia = request.build_absolute_uri(reverse('evidencia_reportehsgi', args=[nueva_hsgi.token]))
